...
const BestSellers = () => {
  ...
  useEffect(() => {
    if (data) {
      const products = data.filter((product) => product.reviewsCount >15);
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5  py-10 gap-4 gap-y-3">
