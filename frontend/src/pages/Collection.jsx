...
const Collection = ({ filteredProducts = [] }) => {
  ...
  // Make sure to handle cases where filteredProducts is not an array
  const filteredAndSortedProducts = applyFilters(Array.isArray(filteredProducts) ? filteredProducts : []);
