...
const registerUser = async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `<p>Click <a href="${process.env.WEB_PATH}/verify-email/${emailToken}">here</a> to verify your email.</p>`,
    };
...
const loginUser = async (req, res) => {
  ...
  try {
    ...
    if (!user.emailVerified) {
      ...
      return res.status(400).json({ message: 'Please verify your email first. A new verification email has been sent.' });
    }
